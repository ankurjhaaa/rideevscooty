...
export default function Contact() {
    ...
    const [selectedReason, setSelectedReason] = useState('Sales Inquiry');
    const reasons = ['Sales Inquiry', 'Technical Support', 'Partnership', 'Other'];
    ...
    function submit(e) {
        e.preventDefault();
        // Simulate form submission to show the exact same modal as BookTestRide
            ...
            <div className="min-h-screen bg-zinc-950 flex flex-col lg:flex-row pt-[72px] lg:pt-[88px]">
                ...
                <div className="w-full lg:w-1/2 min-h-[45vh] lg:h-[calc(100vh-88px)] bg-black lg:sticky lg:top-[88px] border-r border-zinc-900 z-10 flex flex-col justify-center relative overflow-hidden">
                    ...
                    <div className="relative z-10 px-8 py-16 lg:px-20">
                        ...
                        >
                            <p className="text-[10px] font-bold tracking-[0.3em] uppercase text-zinc-500 mb-4">Get in touch</p>
                            ...
                            <p className="text-lg lg:text-xl font-light text-zinc-400 max-w-sm mb-16 lg:mb-24">
                                We're ready to talk about the future of mobility. Drop us a line.
                            </p>
                        </motion.div>
                ...
                <div className="w-full lg:w-1/2 bg-zinc-950 flex flex-col relative z-20 -mt-6 lg:mt-0 rounded-t-3xl lg:rounded-none shadow-[0_-20px_40px_rgba(0,0,0,0.8)] lg:shadow-none pb-24 lg:pb-0">
                    <form onSubmit={submit} className="flex-1 px-4 lg:px-16 py-6 lg:py-12 lg:space-y-8">
                            ...
                            <div className="space-y-6 lg:space-y-8">
                                ...
                                <div>
                                    ...
                                    <div className="flex border-b border-zinc-700 focus-within:border-white transition-colors">
                                        ...
                                        <input type="tel" placeholder="98765 43210" className="w-full bg-transparent py-3 text-lg font-light text-white focus:outline-none placeholder:text-zinc-600" required />
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="lg:bg-zinc-900/40 lg:backdrop-blur-md lg:rounded-2xl py-6 lg:p-10 border-b lg:border border-zinc-900 lg:border-zinc-800">
                            <h2 className="text-lg lg:text-xl font-medium text-white mb-6 lg:mb-8">2. How can we help?</h2>
                            
                            <div className="space-y-6 lg:space-y-8">
                                <div>
                                    <label className={labelClass}>Subject / Reason</label>
                                    <div className="flex flex-wrap gap-3">
                                        {reasons.map((opt) => (
                                            <button
                                                ...
                                                className={`px-5 py-2 rounded-full text-[10px] lg:text-xs font-bold tracking-widest uppercase transition-all duration-300 ${selectedReason === opt ? 'bg-white text-black shadow-[0_0_15px_rgba(255,255,255,0.2)]' : 'border border-zinc-800 lg:border-transparent bg-zinc-900 lg:bg-zinc-800/50 text-zinc-500 hover:text-white'}`}
                                            >
                                                {opt}
                                            </button>
                                        ))}
                                ...
                                <div>
                                    ...
                                    <textarea rows="4" placeholder="Tell us everything..." className={`${inputClass} resize-none`} required></textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="fixed bottom-0 left-0 right-0 lg:relative lg:bottom-auto lg:left-auto lg:right-auto bg-zinc-950/90 lg:bg-transparent backdrop-blur-xl lg:backdrop-blur-none border-t border-zinc-900 lg:border-none p-4 lg:p-0 lg:pt-8 z-50">
                            <button
                                type="submit"
                                className="bg-white text-black px-12 py-4 rounded-full text-xs lg:text-sm font-bold tracking-[0.2em] uppercase transition-all duration-300 w-full shadow-[0_0_30px_rgba(255,255,255,0.1)] hover:shadow-[0_0_40px_rgba(255,255,255,0.2)]"
                            >
                                Send Message
                            </button>
