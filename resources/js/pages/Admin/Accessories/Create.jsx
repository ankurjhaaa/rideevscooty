...
export default function Create() {
    ...
    function submit(e) {
        e.preventDefault();
        post('/admin/accessories', { forceFormData: true });
    }

    return (
        <AdminLayout>
            <Head title="Add Accessory" />

            <div className="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                <div>
                    <h1 className="text-xl font-semibold text-[#1b1b18] dark:text-[#EDEDEC]">Add Accessory</h1>
                    <p className="mt-1 text-sm text-[#706f6c] dark:text-[#A1A09A]">
                        Naya accessory add karo.
                    </p>
                </div>
                <Link
            ...
            >
                <AccessoryForm data={data} setData={setData} errors={errors} />
                ...
                <div className="mt-6 flex gap-3">
                    ...
                    >
                        {processing ? 'Saving...' : 'Save Accessory'}
                    </button>
                    <Link
                        href="/admin/accessories"
