...
export default function Edit({ accessory }) {
    ...
    function submit(e) {
        e.preventDefault();
        post(`/admin/accessories/${accessory.id}`, { forceFormData: true });
    }
    ...
    return (
        <AdminLayout>
            ...
            <div className="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                <div>
                    <h1 className="text-xl font-semibold text-[#1b1b18] dark:text-[#EDEDEC]">Edit Accessory</h1>
                    <p className="mt-1 text-sm text-[#706f6c] dark:text-[#A1A09A]">
                        {accessory.name} ki details update karo.
                    </p>
                </div>
                <Link
            ...
            >
                <AccessoryForm
                    ...
                    setData={setData}
                    errors={errors}
                    existingImageUrl={accessory.image_url}
                />
                ...
                <div className="mt-6 flex gap-3">
                    ...
                    >
                        {processing ? 'Saving...' : 'Update Accessory'}
                    </button>
                    <Link
                        href="/admin/accessories"
