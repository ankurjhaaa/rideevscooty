    ...
    return (
        <AdminLayout>
            ...
            <div className="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                <div>
                    <h1 className="text-xl font-semibold text-[#1b1b18] dark:text-[#EDEDEC]">Add Video</h1>
                    <p className="mt-1 text-sm text-[#706f6c] dark:text-[#A1A09A]">
                        Naya YouTube/Instagram video card add karo.
                    </p>
                </div>
                <Link
                    href="/admin/videos"
            ...
            >
                <VideoForm data={data} setData={setData} errors={errors} />
