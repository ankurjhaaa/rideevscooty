...
export default function Edit({ category }) {
    ...
    function submit(e) {
        e.preventDefault();
        post(`/admin/categories/${category.slug}`, { forceFormData: true });
    }
    ...
    return (
        <AdminLayout>
            ...
            <div className="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                <div>
                    <h1 className="text-xl font-semibold text-[#1b1b18] dark:text-[#EDEDEC]">Edit Category</h1>
                    <p className="mt-1 text-sm text-[#706f6c] dark:text-[#A1A09A]">{category.name} ki details update karo.</p>
                </div>
                <Link
            ...
            >
                <CategoryForm data={data} setData={setData} errors={errors} existingImageUrl={category.image_url} />
