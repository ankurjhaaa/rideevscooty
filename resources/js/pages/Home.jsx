        ...
        >
            <div className="aspect-[4/3] overflow-hidden bg-[#f4f4f3] dark:bg-[#1c1c1a]">
                {image ? (
                    ...
                    <div className="flex h-full w-full flex-col items-center justify-center bg-[#f4f4f3] p-4 text-center dark:bg-[#1c1c1a]">
                        <svg className="mb-2 h-10 w-10 text-[#a3a29e] opacity-40 transition-transform duration-300 group-hover:scale-105" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                           <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" />
                        </svg>
                        <span className="text-xs font-medium text-[#a3a29e]">Image Coming Soon</span>
                    </div>
                )}
            </div>
            <div className="p-5">
            ...
            <section className="relative overflow-hidden bg-[#0a0a0a]">
                <div className="mx-auto grid max-w-6xl items-center gap-10 px-4 py-20 sm:px-6 lg:grid-cols-2 lg:py-28">
                    ...
                    {heroImage ? (
                        ...
                        <div className="mx-auto flex aspect-[4/3] w-full max-w-md flex-col items-center justify-center rounded-2xl border-2 border-dashed border-[#3E3E3A] bg-[#161615]">
                            <svg className="mb-3 h-16 w-16 text-[#a3a29e] opacity-40" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" />
                            </svg>
                            <span className="text-sm font-medium text-[#a3a29e]">Scooter Image Pending</span>
                        </div>
                    )}
                </div>
            </section>
